...
//
// On Fri Oct 23 17:47:37 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkCSR_MIP(CLK,
  ...
  // value method mv_read
  assign mv_read = { 20'd0, new_mip__h522 } ;

  // actionvalue method mav_write
  assign mav_write = { 20'd0, new_mip__h940 } ;
  ...
  assign new_mip__h940 =
	     { rg_meip,
	       ...
	       ssip__h560,
	       usip__h561 } ;
  assign seip__h556 = mav_write_misa[18] && mav_write_wordxl[9] ;
  assign ssip__h560 = mav_write_misa[18] && mav_write_wordxl[1] ;
  assign stip__h558 = mav_write_misa[18] && mav_write_wordxl[5] ;
  assign ueip__h557 = mav_write_misa[13] && mav_write_wordxl[8] ;
  assign usip__h561 = mav_write_misa[13] && mav_write_wordxl[0] ;
  assign utip__h559 = mav_write_misa[13] && mav_write_wordxl[4] ;
