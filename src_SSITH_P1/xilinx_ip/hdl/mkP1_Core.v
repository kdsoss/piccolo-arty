...
//
// On Tue Aug 20 14:59:52 BST 2019
//
//
// Ports:
// Name                         I/O  size props
...
// master1_wdata                  O   128 reg
// master1_wstrb                  O    16 reg
...
module mkP1_Core(CLK,
  ...
  output [127 : 0] master0_wdata;

  // value method master0_w_wstrb
  output [15 : 0] master0_wstrb;
  ...
  output [127 : 0] master1_wdata;

  // value method master1_w_wstrb
  output [15 : 0] master1_wstrb;
  ...
  wire [127 : 0] core$cpu_dmem_master_rdata,
  ...
  wire [15 : 0] core$cpu_dmem_master_wstrb, core$cpu_imem_master_wstrb;
