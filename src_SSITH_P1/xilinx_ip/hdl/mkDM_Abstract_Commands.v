...
//
// On Sun Mar  1 15:57:18 GMT 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_Abstract_Commands(CLK,
  ...
  wire [31 : 0] virt_rg_abstractcs__h504, virt_rg_command__h550;
  wire [15 : 0] regno__h1855;
  wire [12 : 0] x__h1037;
  ...
  always@(av_read_dm_addr or
	  rg_data0 or virt_rg_abstractcs__h504 or virt_rg_command__h550)
  begin
    case (av_read_dm_addr)
      7'h16: av_read = virt_rg_abstractcs__h504;
      7'h17: av_read = virt_rg_command__h550;
  ...
  assign MUX_f_hart0_gpr_reqs$enq_1__VAL_2 =
	     { 1'd0, x__h1037[4:0], 32'hAAAAAAAA } ;
  ...
  // remaining internal signals
  assign regno__h1855 = { 3'd0, rg_command_access_reg_regno } ;
  ...
  assign virt_rg_abstractcs__h504 =
	     { 19'd0, rg_abstractcs_busy, 1'b0, rg_abstractcs_cmderr, 8'd1 } ;
  assign virt_rg_command__h550 =
	     { 15'd17, rg_command_access_reg_write, regno__h1855 } ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  write_dm_addr != 7'h17 &&
	  write_dm_addr != 7'h04)
	$write("%0d: DM_Abstract_Commands.write: [", v__h3257);
    if (RST_N != `BSV_RESET_VALUE)
