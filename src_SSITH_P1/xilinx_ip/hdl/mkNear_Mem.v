...
//
// On Wed Jun 19 16:02:36 BST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkNear_Mem(CLK,
  ...
  begin
    ...
    v__h1585 = v__h1591 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && NOT_cfg_verbosity_read_ULE_1___d9)
	$display("%0d: Near_Mem.rl_reset", v__h1585);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h1736 = v__h1742 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete && NOT_cfg_verbosity_read_ULE_1___d9)
	$display("%0d: Near_Mem.rl_reset_complete", v__h1736);
  end
  // synopsys translate_on
