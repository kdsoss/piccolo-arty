...
module mkCSR_RegFile(CLK,
  ...
  wire [31 : 0] IF_csr_ret_actions_from_priv_EQ_0b11_05_THEN_c_ETC___d926,
		_theResult___fst__h9250,
		_theResult___fst__h9451,
		...
		mask__h9271,
		mask__h9288,
		new_csr_value__h5083,
		new_csr_value__h5751,
		new_dcsr__h5882,
		v__h4864,
		v__h4935,
		v__h5133,
		val__h9289,
		vector_offset__h8249,
		wordxl1__h4384,
		x__h4158,
		x__h6684,
		x__h9097,
		...
		y__h9284,
		y__h9301;
  wire [22 : 0] fixed_up_val_23__h4434,
		fixed_up_val_23__h7436,
		fixed_up_val_23__h9169;
  wire [5 : 0] ie_from_x__h9234, pie_from_x__h9235;
  ...
  wire [3 : 0] exc_code__h8941;
  wire [1 : 0] mpp__h8360, to_y__h9450;
  ...
  // actionvalue method mav_csr_write
  assign mav_csr_write = { x__h4158, 33'h0AAAAAAAA } ;
  ...
  // actionvalue method csr_trap_actions
  assign csr_trap_actions = { x__h6684, x__h9097, x__h9098, 2'b11 } ;
  ...
  assign MUX_rw_minstret$wset_1__VAL_1 =
	     (mav_csr_write_csr_addr == 12'hB02) ? x__h5577 : x__h5673 ;
  ...
  case (1'b1)
    ...
    MUX_rg_dcsr$write_1__SEL_2: rg_dcsr$D_IN = new_dcsr__h5882;
  ...
  assign rg_tdata1$D_IN =
	     MUX_rg_tdata1$write_1__SEL_1 ? new_csr_value__h5751 : 32'd0 ;
  assign rg_tdata1$EN =
	     EN_mav_csr_write &&
	     mav_csr_write_csr_addr_ULT_0xB03_23_OR_NOT_mav_ETC___d436 &&
	     mav_csr_write_csr_addr == 12'h7A1 ||
  ...
  assign IF_csr_ret_actions_from_priv_EQ_0b11_05_THEN_c_ETC___d944 =
		 ...
		 _theResult___fst__h9250 } :
	       { to_y__h9450, _theResult___fst__h9451 } ;
  ...
  assign NOT_csr_trap_actions_nmi_73_AND_csr_trap_actio_ETC___d850 =
	     !csr_trap_actions_nmi && csr_trap_actions_interrupt &&
	     exc_code__h8941 != 4'd0 &&
	     exc_code__h8941 != 4'd1 &&
	     exc_code__h8941 != 4'd2 &&
	     exc_code__h8941 != 4'd3 &&
	     exc_code__h8941 != 4'd4 &&
	     exc_code__h8941 != 4'd5 &&
	     exc_code__h8941 != 4'd6 &&
	     exc_code__h8941 != 4'd7 &&
	     exc_code__h8941 != 4'd8 &&
	     exc_code__h8941 != 4'd9 &&
	     exc_code__h8941 != 4'd10 &&
	     exc_code__h8941 != 4'd11 ;
  ...
  assign _theResult___fst__h9250 =
  ...
  assign _theResult___fst__h9451 =
  ...
  assign csr_trap_actions_nmi_OR_NOT_csr_trap_actions_i_ETC___d901 =
	     ...
	     exc_code__h8941 != 4'd9 &&
	     exc_code__h8941 != 4'd11 &&
	     exc_code__h8941 != 4'd12 &&
	     exc_code__h8941 != 4'd13 &&
	     exc_code__h8941 != 4'd15 ;
  assign exc_code__h8941 =
	     csr_trap_actions_nmi ? 4'd0 : csr_trap_actions_exc_code ;
  assign exc_pc___1__h8310 = exc_pc__h8248 + vector_offset__h8249 ;
  assign exc_pc__h7997 = { rg_mtvec[30:1], 2'd0 } ;
  assign exc_pc__h8248 =
	     csr_trap_actions_nmi ? rg_nmi_vector : exc_pc__h7997 ;
  assign fixed_up_val_23__h4434 =
  ...
  assign fixed_up_val_23__h9169 =
		...
		2'b11) ?
		 ...
		 2'b0,
	       ...
	       2'd0 } ;
  assign ie_from_x__h9234 = { 4'd0, csr_ret_actions_from_priv } ;
  assign mask__h9271 = 32'd1 << pie_from_x__h9235 ;
  assign mask__h9288 = 32'd1 << ie_from_x__h9234 ;
  ...
  assign mpp__h8360 =
	     (csr_trap_actions_from_priv == 2'b11) ?
	       csr_trap_actions_from_priv :
	       2'b0 ;
  assign new_csr_value__h5083 = { mav_csr_write_word[31:1], 1'd0 } ;
  assign new_csr_value__h5751 = { 4'd0, mav_csr_write_word[27:0] } ;
  assign new_dcsr__h5882 =
	     { rg_dcsr[31:16],
	       ...
	       rg_dcsr[3],
	       mav_csr_write_word[2:0] } ;
  assign pie_from_x__h9235 = { 4'd1, csr_ret_actions_from_priv } ;
  assign to_y__h9450 =
	     { 1'b0,
	       csr_mstatus_rg_mstatus_20_AND_INV_1_SL_0_CONCA_ETC___d919[8] } ;
  assign v__h4864 =
	     { mav_csr_write_word[31:2], 1'b0, mav_csr_write_word[0] } ;
  assign v__h4935 = { 29'd0, mav_csr_write_word[2:0] } ;
  assign v__h5133 =
	     { mav_csr_write_word[31], 27'd0, mav_csr_write_word[3:0] } ;
  assign val__h9289 = { 31'd0, b__h9287 } << ie_from_x__h9234 ;
  assign vector_offset__h8249 = { 26'd0, csr_trap_actions_exc_code, 2'd0 } ;
  assign wordxl1__h4384 = { 9'd0, fixed_up_val_23__h4434 } ;
  assign x__h4158 =
	     NOT_mav_csr_write_csr_addr_ULT_0xB03_23_06_AND_ETC___d617 ?
	       32'd0 :
	       IF_mav_csr_write_csr_addr_EQ_0x300_37_THEN_0_C_ETC___d644 ;
  assign x__h5577 = { rg_minstret[63:32], mav_csr_write_word } ;
  assign x__h5673 = { mav_csr_write_word, rg_minstret[31:0] } ;
  assign x__h6684 =
	     (csr_trap_actions_interrupt && !csr_trap_actions_nmi &&
	      rg_mtvec[0]) ?
	       exc_pc___1__h8310 :
	       exc_pc__h8248 ;
  assign x__h9097 = { 9'd0, fixed_up_val_23__h7436 } ;
  assign x__h9098 =
	     { !csr_trap_actions_nmi && csr_trap_actions_interrupt,
	       27'd0,
	       exc_code__h8941 } ;
  assign x__h9270 = x__h9300 | val__h9289 ;
  assign x__h9283 = x__h9270 & y__h9284 ;
  assign x__h9300 = csr_mstatus_rg_mstatus & y__h9301 ;
  assign y__h9284 = ~mask__h9271 ;
  assign y__h9301 = ~mask__h9288 ;
  always@(mav_csr_write_csr_addr or
	  ...
	  v__h4864 or
	  v__h4935 or
	  new_csr_value__h5083 or
	  v__h5133 or
	  csr_mip$mav_write or new_csr_value__h5751 or new_dcsr__h5882)
  begin
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__02_ULE_1_03___d604)
	$write("    Return: new pc 0x%0h  ", x__h6684);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__02_ULE_1_03___d604)
	$write(" new mstatus:");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__02_ULE_1_03___d604 &&
	  NOT_csr_trap_actions_nmi_73_AND_csr_trap_actio_ETC___d850)
	$write("unknown interrupt Exc_Code %d", exc_code__h8941);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__02_ULE_1_03___d604 &&
	  (csr_trap_actions_nmi || !csr_trap_actions_interrupt) &&
	  exc_code__h8941 == 4'd0)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__02_ULE_1_03___d604 &&
	  csr_trap_actions_nmi_OR_NOT_csr_trap_actions_i_ETC___d901)
	$write("unknown trap Exc_Code %d", exc_code__h8941);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__02_ULE_1_03___d604)
