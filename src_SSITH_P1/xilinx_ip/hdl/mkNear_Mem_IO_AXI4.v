...
//
// On Thu Jul 11 16:07:01 BST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkNear_Mem_IO_AXI4(CLK,
  ...
  reg [63 : 0] _theResult___fst__h12580;
  ...
  reg [1 : 0] CASE_byte_addr2387_0x0_0_0x4_0_0x4000_0_0x4004_ETC__q6,
	      CASE_byte_addr3474_0x0_0_0x4_0_0x4000_0_0x4004_ETC__q5;
  reg CASE_IF_slave_xactor_widened_slave_split_ar_ff_ETC__q4;
  wire [127 : 0] new_r_rdata__h9127, v_rdata__h8635;
  wire [63 : 0] byte_addr__h12387,
		byte_addr__h13474,
  ...
  assign MUX_crg_time$port1__write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     !slave_xactor_shim_awff_first__24_BITS_92_TO_29_ETC___d626 &&
	     (byte_addr__h13474 == 64'h000000000000BFF8 ||
	      byte_addr__h13474 == 64'h000000000000BFFC) ;
  assign MUX_crg_timecmp$port1__write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     !slave_xactor_shim_awff_first__24_BITS_92_TO_29_ETC___d626 &&
	     (byte_addr__h13474 == 64'h0000000000004000 ||
	      byte_addr__h13474 == 64'h0000000000004004) ;
  assign MUX_rg_msip$write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     !slave_xactor_shim_awff_first__24_BITS_92_TO_29_ETC___d626 &&
	     byte_addr__h13474 == 64'h0 &&
	     !rg_msip_95_EQ_slave_xactor_shim_wff_first__30__ETC___d632 ;
  ...
  assign crg_time$port1__write_1 =
	     MUX_crg_time$port1__write_1__SEL_1 ? new_time__h15204 : 64'd1 ;
  ...
  assign slave_xactor_shim_rff$D_IN =
	     { slave_xactor_shim_arff$D_OUT[97:93],
	       ...
	       slave_xactor_shim_arff_first__32_BITS_92_TO_29_ETC___d559 ?
		 2'd3 :
		 CASE_byte_addr2387_0x0_0_0x4_0_0x4000_0_0x4004_ETC__q6,
	       1'd1 } ;
  ...
  assign new_time__h15204 = x__h15246 | y__h13959 ;
  assign new_timecmp__h13916 = x__h13958 | y__h13959 ;
  ...
  assign new_w_wstrb__h5334 =
	     (!slave_xactor_widened_slave_shim_awff_rv$port1__read[32] &&
		  ...
		  slave_xactor_widened_slave_shim_wff_rv$port1__read[16:9] :
		  slave_xactor_widened_slave_shim_wff_rv$port1__read[8:1]) ;
  assign old_time__h17763 =
	     CAN_FIRE_RL_rl_tick_timer ? crg_time$port0__write_1 : crg_time ;
  assign rdata___1__h12576 = { 63'd0, rg_msip } ;
  ...
  assign slave_xactor_shim_arff_first__32_BITS_92_TO_29_ETC___d592 =
	     (slave_xactor_shim_arff_first__32_BITS_92_TO_29_ETC___d559 ||
	      byte_addr__h12387 != 64'h0 &&
	      byte_addr__h12387 != 64'h0000000000004000 &&
	      byte_addr__h12387 != 64'h000000000000BFF8 &&
	      byte_addr__h12387 != 64'h0000000000000004 &&
	      byte_addr__h12387 != 64'h0000000000004004 &&
	      byte_addr__h12387 != 64'h000000000000BFFC) &&
  ...
  assign slave_xactor_shim_awff_first__24_BITS_92_TO_29_ETC___d769 =
	     (slave_xactor_shim_awff_first__24_BITS_92_TO_29_ETC___d626 ||
	      ...
	      byte_addr__h13474 != 64'h0000000000004000 &&
	      byte_addr__h13474 != 64'h000000000000BFF8 &&
	      byte_addr__h13474 != 64'h0000000000000004 &&
	      byte_addr__h13474 != 64'h0000000000004004 &&
	      byte_addr__h13474 != 64'h000000000000BFFC) &&
  ...
  assign x__h13958 = crg_timecmp & y__h13960 ;
  assign x__h15246 = old_time__h17763 & y__h13960 ;
  assign x__h4408 =
	     8'd1 <<
	     slave_xactor_widened_slave_shim_awff_rv$port1__read[20:18] ;
  assign x__h4441 =
  ...
  assign x_first__h4108 =
	     slave_xactor_widened_slave_first_r_ff$EMPTY_N ?
	       slave_xactor_widened_slave_first_r_ff$D_OUT :
	       slave_xactor_shim_rff$D_OUT[66:3] ;
  assign y__h13959 = slave_xactor_shim_wff$D_OUT[72:9] & mask__h13947 ;
  assign y__h13960 =
	     { ~SEXT_slave_xactor_shim_wff_first__30_BIT_8_99___d700,
	       ~SEXT_slave_xactor_shim_wff_first__30_BIT_7_02___d703,
	       ~SEXT_slave_xactor_shim_wff_first__30_BIT_6_06___d707,
  ...
  always@(byte_addr__h12387 or rdata___1__h12576 or crg_timecmp or crg_time)
  begin
    case (byte_addr__h12387)
      64'h0: _theResult___fst__h12580 = rdata___1__h12576;
      64'h0000000000000004: _theResult___fst__h12580 = 64'd0;
      64'h0000000000004000, 64'h0000000000004004:
	  _theResult___fst__h12580 = crg_timecmp;
      64'h000000000000BFF8, 64'h000000000000BFFC:
	  _theResult___fst__h12580 = crg_time;
      default: _theResult___fst__h12580 = 64'd0;
    endcase
  end
  always@(sz__h4590)
  begin
  ...
  always@(byte_addr__h13474)
  begin
    case (byte_addr__h13474)
      64'h0,
	  ...
	  CASE_byte_addr3474_0x0_0_0x4_0_0x4000_0_0x4004_ETC__q5 = 2'd0;
      default: CASE_byte_addr3474_0x0_0_0x4_0_0x4000_0_0x4004_ETC__q5 = 2'd3;
    endcase
  end
  always@(byte_addr__h12387)
  begin
    case (byte_addr__h12387)
      64'h0,
      64'h0000000000000004,
      ...
      64'h000000000000BFF8,
      64'h000000000000BFFC:
	  CASE_byte_addr2387_0x0_0_0x4_0_0x4000_0_0x4004_ETC__q6 = 2'd0;
      default: CASE_byte_addr2387_0x0_0_0x4_0_0x4000_0_0x4004_ETC__q6 = 2'd3;
    endcase
  end
  ...
  begin
    ...
    v__h11777 = v__h11783 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && cfg_verbosity != 4'd0)
	$display("%0d: Near_Mem_IO_AXI4.rl_reset", v__h11777);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h12916 = v__h12922 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read__94_ULE_1_18___d519)
	$display("%0d: Near_Mem_IO_AXI4.rl_process_rd_req", v__h12916);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read__94_ULE_1_18___d519)
	$write("            ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h13474 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read__94_ULE_1_18___d519)
	$display("        new MTIMECMP         = 0x%0h", new_timecmp__h13916);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_shim_awff_first__24_BITS_92_TO_29_ETC___d626 &&
	  byte_addr__h13474 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read__94_ULE_1_18___d519)
	$display("        cur MTIME            = 0x%0h", old_time__h17763);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_shim_awff_first__24_BITS_92_TO_29_ETC___d626 &&
	  byte_addr__h13474 == 64'h0000000000004000 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h13474 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read__94_ULE_1_18___d519)
	$display("        old MTIME = 0x%0h", old_time__h17763);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_shim_awff_first__24_BITS_92_TO_29_ETC___d626 &&
	  byte_addr__h13474 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read__94_ULE_1_18___d519)
	$display("        new MTIME = 0x%0h", new_time__h15204);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_shim_awff_first__24_BITS_92_TO_29_ETC___d626 &&
	  byte_addr__h13474 == 64'h0000000000004004 &&
    ...
    v__h19321 = v__h19327 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read__94_ULE_1_18___d519)
	$display("%0d: Near_Mem_IO.AXI4.rl_process_wr_req", v__h19321);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read__94_ULE_1_18___d519)
	$write("            ");
