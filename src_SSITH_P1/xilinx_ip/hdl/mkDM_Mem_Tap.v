...
//
// On Tue Aug 20 14:57:59 BST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_Mem_Tap(CLK,
  ...
  wire [74 : 0] slave_xactor_ug_slave_u_w_putWire$wget;
  ...
  reg [73 : 0] slave_xactor_shim_rff_rv;
  wire [73 : 0] slave_xactor_shim_rff_rv$D_IN;
  wire slave_xactor_shim_rff_rv$EN;

  // register slave_xactor_shim_wff_rv
  reg [75 : 0] slave_xactor_shim_wff_rv;
  wire [75 : 0] slave_xactor_shim_wff_rv$D_IN;
  ...
  wire [74 : 0] master_xactor_shim_wff_rvport1__read_BITS_74__ETC__q2;
  wire [63 : 0] stval___1__h6721, x__h6719, y_avValue_fst__h6631;
  wire slave_xactor_shim_wff_rv_port1__read__6_BIT_75_ETC___d97;
  ...
  // value method slave_w_wready
  assign slave_wready = !slave_xactor_shim_wff_rv[75] ;
  ...
  // value method slave_r_rid
  assign slave_rid = slave_xactor_ug_slave_u_r_peekWire$wget[72:69] ;

  // value method slave_r_rdata
  assign slave_rdata = slave_xactor_ug_slave_u_r_peekWire$wget[68:5] ;

  // value method slave_r_rresp
  assign slave_rresp = slave_xactor_ug_slave_u_r_peekWire$wget[4:3] ;

  // value method slave_r_rlast
  assign slave_rlast = slave_xactor_ug_slave_u_r_peekWire$wget[2] ;

  // value method slave_r_ruser
  assign slave_ruser = slave_xactor_ug_slave_u_r_peekWire$wget[1:0] ;
  ...
  // value method master_w_wdata
  assign master_wdata =
	     master_xactor_shim_wff_rvport1__read_BITS_74__ETC__q2[74:11] ;

  // value method master_w_wstrb
  assign master_wstrb =
	     master_xactor_shim_wff_rvport1__read_BITS_74__ETC__q2[10:3] ;

  // value method master_w_wlast
  assign master_wlast =
	     master_xactor_shim_wff_rvport1__read_BITS_74__ETC__q2[2] ;

  // value method master_w_wuser
  assign master_wuser =
	     master_xactor_shim_wff_rvport1__read_BITS_74__ETC__q2[1:0] ;
  ...
  assign CAN_FIRE_RL_write_reqs =
	     ...
	     slave_xactor_shim_wff_rv_port1__read__6_BIT_75_ETC___d97 ;
  ...
  assign CAN_FIRE_RL_slave_xactor_ug_slave_u_r_setPeek =
	     slave_xactor_shim_rff_rv$port1__read[73] ;
  ...
  assign slave_xactor_ug_slave_u_w_putWire$whas =
	     slave_wvalid && !slave_xactor_shim_wff_rv[75] ;
  ...
  assign slave_xactor_ug_slave_u_r_peekWire$wget =
	     slave_xactor_shim_rff_rv$port1__read[72:0] ;
  ...
  assign slave_xactor_ug_slave_u_r_dropWire$whas =
	     slave_xactor_shim_rff_rv$port1__read[73] && slave_rready ;
  ...
  assign slave_xactor_shim_rff_rv$port0__write_1 =
	     { 1'd1, master_xactor_shim_rff_rv$port1__read[72:0] } ;
  ...
  assign master_xactor_shim_wff_rv$port0__write_1 =
	     { 1'd1, slave_xactor_shim_wff_rv$port1__read[74:0] } ;
  ...
  assign master_xactor_shim_wff_rvport1__read_BITS_74__ETC__q2 =
	     master_xactor_shim_wff_rv$port1__read[74:0] ;
  assign slave_xactor_shim_wff_rv_port1__read__6_BIT_75_ETC___d97 =
	     slave_xactor_shim_wff_rv$port1__read[75] &&
	     !master_xactor_shim_awff_rv[97] &&
	     !master_xactor_shim_wff_rv[75] &&
	     f_trace_data$FULL_N ;
  assign stval___1__h6721 =
	     { 32'd0, slave_xactor_shim_wff_rv$port1__read[42:11] } ;
  assign x__h6719 =
	     (slave_xactor_shim_wff_rv$port1__read[10:3] == 8'h0F) ?
	       stval___1__h6721 :
	       y_avValue_fst__h6631 ;
  assign y_avValue_fst__h6631 =
	     { 32'd0, slave_xactor_shim_wff_rv$port1__read[74:43] } ;
  ...
  begin
    ...
    slave_xactor_shim_rff_rv = 74'h2AAAAAAAAAAAAAAAAAA;
    slave_xactor_shim_wff_rv = 76'hAAAAAAAAAAAAAAAAAAA;
  end
