...
module mkDM_Mem_Tap(CLK,
  ...
  reg [1 : 0] sz__h1648;
  wire [63 : 0] stval__h1637, x__h1868;
  wire [31 : 0] x__h1802;
  ...
  assign slave_xactor_f_wr_data_i_notEmpty_AND_master_x_ETC___d8 =
	     ...
	     master_xactor_f_wr_data$FULL_N &&
	     f_trace_data$FULL_N ;
  assign stval__h1637 = x__h1868 & y__h1869 ;
  assign x__h1802 = { 30'd0, sz__h1648 } ;
  assign x__h1868 =
  ...
  begin
    case (slave_xactor_f_wr_data$D_OUT[8:1])
      8'h03, 8'h0C, 8'h30, 8'hC0: sz__h1648 = 2'b01;
      8'h0F, 8'hF0: sz__h1648 = 2'b10;
      8'h10, 8'h20, 8'h40, 8'h80: sz__h1648 = 2'b0;
      8'hFF: sz__h1648 = 2'b11;
      default: sz__h1648 = 2'b0;
    endcase
  end
  always@(slave_xactor_f_wr_data$D_OUT)
  begin
    case (slave_xactor_f_wr_data$D_OUT[8:1])
	  ...
	  y__h1869 = 64'h00000000000000FF;
      8'h03, 8'h0C, 8'h30, 8'hC0: y__h1869 = 64'h000000000000FFFF;
      8'h0F, 8'hF0: y__h1869 = 64'h00000000FFFFFFFF;
      8'hFF: y__h1869 = 64'hFFFFFFFFFFFFFFFF;
      default: y__h1869 = 64'd0;
    endcase
  end
