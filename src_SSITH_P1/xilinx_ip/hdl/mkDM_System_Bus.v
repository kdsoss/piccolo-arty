...
//
// On Tue Aug 13 15:43:15 BST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_System_Bus(CLK,
  ...
  reg [63 : 0] CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q1,
	       ...
	       wrd_wdata__h7240;
  reg [7 : 0] wrd_wstrb__h7241;
  reg [2 : 0] _theResult___snd_snd_val__h7126, axi4_size_val__h5395;
  ...
  wire [63 : 0] _theResult___fst__h7111,
		addr64417_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_TH_ETC__q2,
		addr64__h6417,
		result__h3808,
		result__h3838,
		result__h3865,
  ...
  wire [31 : 0] IF_rg_sbcs_sbreadonaddr_75_THEN_IF_rg_sbcs_sba_ETC___d361,
		v__h4807,
		v__h4941;
  wire [7 : 0] strobe64__h7109, strobe64__h7113, strobe64__h7117;
  wire [5 : 0] shift_bits__h7059;
  ...
  assign MUX_master_xactor_shim_arff_rv$port0__write_1__VAL_2 =
	     { 5'd16, addr64__h6417, 8'd0, axi4_size_val__h5395, 18'd65536 } ;
  ...
  assign master_xactor_shim_awff_rv$port0__write_1 =
	     { 5'd16,
	       sbaddress__h3099,
	       8'd0,
	       _theResult___snd_snd_val__h7126,
	       18'd65536 } ;
  ...
  assign master_xactor_shim_wff_rv$port0__write_1 =
	     { 1'd1, wrd_wdata__h7240, wrd_wstrb__h7241, 3'd6 } ;
  ...
  assign IF_rg_sbcs_sbreadonaddr_75_THEN_IF_rg_sbcs_sba_ETC___d361 =
	     rg_sbcs_sbreadonaddr ?
		  ...
		  addr64417_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_TH_ETC__q2[31:0] :
		  write_dm_word) :
	       write_dm_word ;
  assign _theResult___fst__h7111 = word64__h7056 << shift_bits__h7059 ;
  assign addr64417_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_TH_ETC__q2 =
	     addr64__h6417 +
	     IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_1_ELSE_IF_rg_ETC___d155 ;
  assign addr64__h6417 = { rg_sbaddress1, write_dm_word } ;
  ...
  assign shift_bits__h7059 = { rg_sbaddress0[2:0], 3'b0 } ;
  assign strobe64__h7109 = 8'b00000001 << rg_sbaddress0[2:0] ;
  assign strobe64__h7113 = 8'b00000011 << rg_sbaddress0[2:0] ;
  assign strobe64__h7117 = 8'b00001111 << rg_sbaddress0[2:0] ;
  assign v__h4807 =
	     { 9'd64,
	       rg_sbcs_sbbusyerror,
	       rg_sb_state != 2'd0,
  ...
  assign v__h4941 =
	     (rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign word64__h7056 = { 32'd0, write_dm_word } ;
  ...
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2, 3'd3:
	  _theResult___snd_snd_val__h7126 = rg_sbcs_sbaccess;
      default: _theResult___snd_snd_val__h7126 = 3'b111;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  strobe64__h7109 or strobe64__h7113 or strobe64__h7117)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: wrd_wstrb__h7241 = strobe64__h7109;
      3'd1: wrd_wstrb__h7241 = strobe64__h7113;
      3'd2: wrd_wstrb__h7241 = strobe64__h7117;
      3'd3: wrd_wstrb__h7241 = 8'b11111111;
      default: wrd_wstrb__h7241 = 8'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess or word64__h7056 or _theResult___fst__h7111)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: wrd_wdata__h7240 = _theResult___fst__h7111;
      default: wrd_wdata__h7240 = word64__h7056;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
