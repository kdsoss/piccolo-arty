...
module mkDM_System_Bus(CLK,
  ...
  reg [63 : 0] CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q1,
	       ...
	       wrd_wdata__h4549;
  reg [7 : 0] wrd_wstrb__h4550;
  reg [2 : 0] x__h4460;
  wire [63 : 0] _theResult___fst__h4498,
		addr64810_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_TH_ETC__q2,
		addr64__h3810,
		result__h1202,
		result__h1232,
		result__h1259,
		...
		result__h1561,
		result__h1588,
		sbaddress37_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9__ETC__q3,
		sbaddress__h637,
		word64__h4442;
  wire [31 : 0] IF_rg_sbcs_sbreadonaddr_20_THEN_IF_rg_sbcs_sba_ETC___d303,
		v__h2144,
		v__h2257;
  wire [7 : 0] strobe64__h4497, strobe64__h4500, strobe64__h4503;
  wire [5 : 0] shift_bits__h4445;
  wire rg_sb_state_EQ_0_7_AND_NOT_rg_sbcs_sbbusyerror_ETC___d109,
       rg_sb_state_EQ_0_7_AND_NOT_rg_sbcs_sbbusyerror_ETC___d309,
       rg_sb_state_EQ_0_7_AND_NOT_rg_sbcs_sbbusyerror_ETC___d95,
       rg_sbcs_sberror_EQ_0_AND_rg_sbcs_sbreadonaddr__ETC___d287,
       write_dm_addr_EQ_0x38_37_AND_rg_sbcs_sberror_E_ETC___d252,
       write_dm_addr_EQ_0x38_37_AND_rg_sbcs_sberror_E_ETC___d261,
       write_dm_addr_EQ_0x38_37_AND_rg_sbcs_sberror_E_ETC___d267,
       write_dm_addr_EQ_0x38_37_AND_rg_sbcs_sberror_E_ETC___d269,
       write_dm_addr_EQ_0x38_37_AND_rg_sbcs_sberror_E_ETC___d274,
       write_dm_addr_EQ_0x3C_57_AND_rg_sb_state_EQ_0__ETC___d319;
  ...
  assign MUX_master_xactor_f_rd_addr$enq_1__VAL_1 =
	     { 4'd0, sbaddress__h637, 8'd0, rg_sbcs_sbaccess, 18'd65536 } ;
  assign MUX_master_xactor_f_rd_addr$enq_1__VAL_2 =
	     { 4'd0, addr64__h3810, 8'd0, rg_sbcs_sbaccess, 18'd65536 } ;
  always@(write_dm_addr or
	  sbaddress37_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9__ETC__q3 or
	  IF_rg_sbcs_sbreadonaddr_20_THEN_IF_rg_sbcs_sba_ETC___d303)
  begin
    case (write_dm_addr)
      7'h39, 7'h3A:
      ...
      default: MUX_rg_sbaddress0$write_1__VAL_2 =
		   sbaddress37_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9__ETC__q3[31:0];
    endcase
  end
  ...
  assign master_xactor_f_wr_addr$D_IN =
	     { 4'd0, sbaddress__h637, 8'd0, x__h4460, 18'd65536 } ;
  ...
  assign master_xactor_f_wr_data$D_IN =
	     { wrd_wdata__h4549, wrd_wstrb__h4550, 1'd1 } ;
  ...
  // remaining internal signals
  assign IF_rg_sbcs_sbreadonaddr_20_THEN_IF_rg_sbcs_sba_ETC___d303 =
	     rg_sbcs_sbreadonaddr ?
	       (rg_sbcs_sbautoincrement ?
		  addr64810_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_TH_ETC__q2[31:0] :
		  write_dm_word) :
	       write_dm_word ;
  assign _theResult___fst__h4498 = word64__h4442 << shift_bits__h4445 ;
  assign addr64810_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_TH_ETC__q2 =
	     addr64__h3810 +
	     IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d103 ;
  assign addr64__h3810 = { rg_sbaddress1, write_dm_word } ;
  ...
  assign rg_sb_state_EQ_0_7_AND_NOT_rg_sbcs_sbbusyerror_ETC___d109 =
	     ...
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadondata ;
  assign rg_sb_state_EQ_0_7_AND_NOT_rg_sbcs_sbbusyerror_ETC___d309 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadonaddr ;
  assign rg_sb_state_EQ_0_7_AND_NOT_rg_sbcs_sbbusyerror_ETC___d95 =
	     ...
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbautoincrement ;
  assign rg_sbcs_sberror_EQ_0_AND_rg_sbcs_sbreadonaddr__ETC___d287 =
	     rg_sbcs_sberror == 3'd0 &&
	     (rg_sbcs_sbreadonaddr && rg_sbcs_sbautoincrement ||
	      write_dm_addr != 7'h39) ;
  assign sbaddress37_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9__ETC__q3 =
	     sbaddress__h637 +
	     IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d103 ;
  assign sbaddress__h637 = { rg_sbaddress1, rg_sbaddress0 } ;
  assign shift_bits__h4445 = { rg_sbaddress0[2:0], 3'b0 } ;
  assign strobe64__h4497 = 8'b00000001 << rg_sbaddress0[2:0] ;
  assign strobe64__h4500 = 8'b00000011 << rg_sbaddress0[2:0] ;
  assign strobe64__h4503 = 8'b00001111 << rg_sbaddress0[2:0] ;
  assign v__h2144 =
	     { 9'd64,
	       rg_sbcs_sbbusyerror,
	       rg_sb_state != 2'd0,
  ...
  assign v__h2257 =
	     (rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign word64__h4442 = { 32'd0, write_dm_word } ;
  assign write_dm_addr_EQ_0x38_37_AND_rg_sbcs_sberror_E_ETC___d252 =
	     write_dm_addr == 7'h38 &&
  ...
  assign write_dm_addr_EQ_0x38_37_AND_rg_sbcs_sberror_E_ETC___d261 =
	     write_dm_addr_EQ_0x38_37_AND_rg_sbcs_sberror_E_ETC___d252 ||
	     (write_dm_addr == 7'h39 || write_dm_addr == 7'h3A ||
	      write_dm_addr == 7'h3C) &&
	     rg_sb_state != 2'd0 ;
  assign write_dm_addr_EQ_0x38_37_AND_rg_sbcs_sberror_E_ETC___d267 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     rg_sbcs_sbbusyerror &&
	     !write_dm_word[22] ;
  assign write_dm_addr_EQ_0x38_37_AND_rg_sbcs_sberror_E_ETC___d269 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || write_dm_word[22]) ;
  assign write_dm_addr_EQ_0x38_37_AND_rg_sbcs_sberror_E_ETC___d274 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || write_dm_word[22]) &&
	     (write_dm_word[19:17] == 3'd4 || write_dm_word[19:17] == 3'd3) ;
  assign write_dm_addr_EQ_0x3C_57_AND_rg_sb_state_EQ_0__ETC___d319 =
  ...
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2, 3'd3: x__h4460 = rg_sbcs_sbaccess;
      default: x__h4460 = 3'b111;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  strobe64__h4497 or strobe64__h4500 or strobe64__h4503)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: wrd_wstrb__h4550 = strobe64__h4497;
      3'd1: wrd_wstrb__h4550 = strobe64__h4500;
      3'd2: wrd_wstrb__h4550 = strobe64__h4503;
      3'd3: wrd_wstrb__h4550 = 8'b11111111;
      default: wrd_wstrb__h4550 = 8'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess or word64__h4442 or _theResult___fst__h4498)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: wrd_wdata__h4549 = _theResult___fst__h4498;
      default: wrd_wdata__h4549 = word64__h4442;
    endcase
  end
