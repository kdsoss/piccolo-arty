...
//
// On Mon Mar 30 04:58:26 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkGPR_RegFile(CLK,
  ...
  wire [33 : 0] thin_address__h1034, thin_address__h1265, thin_address__h747;
  wire [7 : 0] thin_addrBits__h1035,
  ...
  wire [3 : 0] thin_otype__h1039, thin_otype__h1270, thin_otype__h752;
  ...
  assign IF_read_rs1_port2_rs1_EQ_0_0_THEN_0_ELSE_regfi_ETC___d137 =
	     x__h1197[7:5] < repBound__h1190 ;
  assign IF_read_rs1_port2_rs1_EQ_0_0_THEN_0_ELSE_regfi_ETC___d139 =
	     thin_addrBits__h1035[7:5] < repBound__h1190 ;
  ...
  assign repBound__h1190 = x__h1197[7:5] - 3'b001 ;
  assign repBound__h1421 = x__h1428[7:5] - 3'b001 ;
  assign repBound__h956 = x__h963[7:5] - 3'b001 ;
  ...
  assign thin_flags__h1268 = read_rs2_rs2 != 5'd0 && regfile$D_OUT_1[27] ;
  assign thin_flags__h750 = read_rs1_rs1 != 5'd0 && regfile$D_OUT_3[27] ;
  ...
  assign x__h1428 = (read_rs2_rs2 == 5'd0) ? 8'd0 : regfile$D_OUT_1[7:0] ;
  assign x__h1431 = (read_rs2_rs2 == 5'd0) ? 8'd64 : regfile$D_OUT_1[15:8] ;
  assign x__h963 = (read_rs1_rs1 == 5'd0) ? 8'd0 : regfile$D_OUT_3[7:0] ;
  assign x__h966 = (read_rs1_rs1 == 5'd0) ? 8'd64 : regfile$D_OUT_3[15:8] ;
