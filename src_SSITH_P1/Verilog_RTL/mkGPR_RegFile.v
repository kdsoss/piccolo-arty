...
//
// On Sun Mar  1 15:57:37 GMT 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkGPR_RegFile(CLK,
  ...
  wire [33 : 0] thin_address__h1033, thin_address__h1264, thin_address__h746;
  wire [7 : 0] thin_addrBits__h1034,
  ...
  wire [3 : 0] thin_otype__h1038, thin_otype__h1269, thin_otype__h751;
  ...
  assign IF_read_rs1_port2_rs1_EQ_0_0_THEN_0_ELSE_regfi_ETC___d137 =
	     x__h1196[7:5] < repBound__h1189 ;
  assign IF_read_rs1_port2_rs1_EQ_0_0_THEN_0_ELSE_regfi_ETC___d139 =
	     thin_addrBits__h1034[7:5] < repBound__h1189 ;
  ...
  assign repBound__h1189 = x__h1196[7:5] - 3'b001 ;
  assign repBound__h1420 = x__h1427[7:5] - 3'b001 ;
  assign repBound__h955 = x__h962[7:5] - 3'b001 ;
  ...
  assign thin_flags__h1267 = read_rs2_rs2 != 5'd0 && regfile$D_OUT_1[27] ;
  assign thin_flags__h749 = read_rs1_rs1 != 5'd0 && regfile$D_OUT_3[27] ;
  ...
  assign x__h1427 = (read_rs2_rs2 == 5'd0) ? 8'd0 : regfile$D_OUT_1[7:0] ;
  assign x__h1430 = (read_rs2_rs2 == 5'd0) ? 8'd64 : regfile$D_OUT_1[15:8] ;
  assign x__h962 = (read_rs1_rs1 == 5'd0) ? 8'd0 : regfile$D_OUT_3[7:0] ;
  assign x__h965 = (read_rs1_rs1 == 5'd0) ? 8'd64 : regfile$D_OUT_3[15:8] ;
