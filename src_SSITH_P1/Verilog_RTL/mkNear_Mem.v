...
//
// On Thu Jul 11 16:07:34 BST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkNear_Mem(CLK,
  ...
  wire [127 : 0] dcache$mem_master_rdata,
		 dcache$mem_master_wdata,
		 dcache$st_amo_val_snd,
		 dcache$word128_snd;
  wire [63 : 0] dcache$mem_master_araddr, dcache$mem_master_awaddr;
  wire [31 : 0] dcache$req_addr, dcache$req_satp;
  wire [15 : 0] dcache$mem_master_wstrb;
  ...
  wire [127 : 0] icache$mem_master_rdata,
		 icache$mem_master_wdata,
		 icache$word128_snd;
  wire [63 : 0] icache$mem_master_araddr, icache$mem_master_awaddr;
  wire [31 : 0] icache$addr, icache$req_addr, icache$req_satp;
  wire [15 : 0] icache$mem_master_wstrb;
  ...
  assign RDY_server_fence_i_request_put =
	     rg_state != 2'd0 && dcache$RDY_server_flush_request_put &&
	     icache$RDY_server_flush_request_put ;
  ...
  // action method sfence_vma
  assign RDY_sfence_vma = dcache$RDY_tlb_flush && icache$RDY_tlb_flush ;
  assign CAN_FIRE_sfence_vma = dcache$RDY_tlb_flush && icache$RDY_tlb_flush ;
  ...
  begin
    ...
    v__h1603 = v__h1609 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && NOT_cfg_verbosity_read_ULE_1___d9)
	$display("%0d: Near_Mem.rl_reset", v__h1603);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h1754 = v__h1760 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete && NOT_cfg_verbosity_read_ULE_1___d9)
	$display("%0d: Near_Mem.rl_reset_complete", v__h1754);
  end
  // synopsys translate_on
