...
//
// On Fri Oct 23 17:47:32 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_Mem_Tap(CLK,
  ...
  wire [63 : 0] stval__h6828, x__h7000;
  wire [31 : 0] x__h6903;
  ...
  assign stval__h6828 = x__h7000 & y__h7001 ;
  assign x__h6903 = { 29'd0, sz__h6839 } ;
  assign x__h7000 =
  ...
  begin
    case (slave_xactor_shim_wff_rv$port1__read[9:2])
	  ...
	  y__h7001 = 64'h00000000000000FF;
      8'h03, 8'h0C, 8'h30, 8'hC0: y__h7001 = 64'h000000000000FFFF;
      8'h0F, 8'hF0: y__h7001 = 64'h00000000FFFFFFFF;
      8'hFF: y__h7001 = 64'hFFFFFFFFFFFFFFFF;
      default: y__h7001 = 64'd0;
    endcase
  end
