...
//
// On Fri Oct 23 17:47:34 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_System_Bus(CLK,
  ...
  wire [72 : 0] master_xactor_shim_rff_rv$port0__write_1,
		...
		master_xactor_shim_rff_rv$port2__write_1,
  ...
  reg [63 : 0] CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q1,
	       ...
	       wrd_wdata__h7230;
  reg [7 : 0] wrd_wstrb__h7231;
  reg [2 : 0] _theResult___snd_snd_val__h7121, axi4_size_val__h5395;
  wire [96 : 0] master_xactor_shim_arff_rvport1__read_BITS_96_ETC__q5,
		master_xactor_shim_awff_rvport1__read_BITS_96_ETC__q3;
  wire [73 : 0] master_xactor_shim_wff_rvport1__read_BITS_73__ETC__q4;
  wire [63 : 0] _theResult___fst__h7106,
		addr64412_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_TH_ETC__q2,
		addr64__h6412,
		result__h3808,
		result__h3838,
		result__h3865,
		...
		result__h4167,
		result__h4194,
		sbaddress099_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_ETC__q6,
		sbaddress__h3099,
		word64__h7051;
  wire [31 : 0] IF_rg_sbcs_sbreadonaddr_75_THEN_IF_rg_sbcs_sba_ETC___d361,
		v__h4807,
		v__h4941;
  wire [7 : 0] strobe64__h7104, strobe64__h7108, strobe64__h7112;
  wire [5 : 0] shift_bits__h7054;
  ...
  // value method master_w_wdata
  assign master_wdata =
	     master_xactor_shim_wff_rvport1__read_BITS_73__ETC__q4[73:10] ;

  // value method master_w_wstrb
  assign master_wstrb =
	     master_xactor_shim_wff_rvport1__read_BITS_73__ETC__q4[9:2] ;

  // value method master_w_wlast
  assign master_wlast =
	     master_xactor_shim_wff_rvport1__read_BITS_73__ETC__q4[1] ;

  // value method master_w_wuser
  assign master_wuser =
	     master_xactor_shim_wff_rvport1__read_BITS_73__ETC__q4[0] ;
  ...
  assign MUX_master_xactor_shim_arff_rv$port0__write_1__VAL_1 =
	     { 5'd16,
	       sbaddress__h3099,
	       8'd0,
	       axi4_size_val__h5395,
	       18'd65536 } ;
  assign MUX_master_xactor_shim_arff_rv$port0__write_1__VAL_2 =
	     { 5'd16, addr64__h6412, 8'd0, axi4_size_val__h5395, 18'd65536 } ;
  always@(write_dm_addr or
	  sbaddress099_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_ETC__q6 or
  ...
  begin
    case (write_dm_addr)
      ...
      default: MUX_rg_sbaddress0$write_1__VAL_2 =
		   sbaddress099_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_ETC__q6[31:0];
    endcase
  end
  ...
  assign master_xactor_shim_awff_rv$port0__write_1 =
	     { 5'd16,
	       sbaddress__h3099,
	       8'd0,
	       _theResult___snd_snd_val__h7121,
	       18'd65536 } ;
  ...
  assign master_xactor_shim_wff_rv$port0__write_1 =
	     { 1'd1, wrd_wdata__h7230, wrd_wstrb__h7231, 2'd2 } ;
  ...
  assign master_xactor_shim_rff_rv$port2__read =
	     master_xactor_shim_rff_rv$EN_port1__write ?
	       master_xactor_shim_rff_rv$port2__write_1 :
	       master_xactor_shim_rff_rv$port1__read ;
  assign master_xactor_shim_rff_rv$port2__write_1 =
	     { 1'd0,
  ...
  assign IF_rg_sbcs_sbreadonaddr_75_THEN_IF_rg_sbcs_sba_ETC___d361 =
	     rg_sbcs_sbreadonaddr ?
		  ...
		  addr64412_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_TH_ETC__q2[31:0] :
		  write_dm_word) :
	       write_dm_word ;
  assign _theResult___fst__h7106 = word64__h7051 << shift_bits__h7054 ;
  assign addr64412_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_TH_ETC__q2 =
	     addr64__h6412 +
	     IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_1_ELSE_IF_rg_ETC___d155 ;
  assign addr64__h6412 = { rg_sbaddress1, write_dm_word } ;
  ...
  assign master_xactor_shim_wff_rvport1__read_BITS_73__ETC__q4 =
  ...
  assign rg_sbcs_sberror_9_EQ_0_0_AND_rg_sbcs_sbreadona_ETC___d345 =
	     ...
	     (rg_sbcs_sbreadonaddr && rg_sbcs_sbautoincrement ||
	      write_dm_addr != 7'h39) ;
  assign sbaddress099_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_ETC__q6 =
	     sbaddress__h3099 +
	     IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_1_ELSE_IF_rg_ETC___d155 ;
  assign sbaddress__h3099 = { rg_sbaddress1, rg_sbaddress0 } ;
  assign shift_bits__h7054 = { rg_sbaddress0[2:0], 3'b0 } ;
  assign strobe64__h7104 = 8'b00000001 << rg_sbaddress0[2:0] ;
  assign strobe64__h7108 = 8'b00000011 << rg_sbaddress0[2:0] ;
  assign strobe64__h7112 = 8'b00001111 << rg_sbaddress0[2:0] ;
  assign v__h4807 =
	     { 9'd64,
	       rg_sbcs_sbbusyerror,
	       rg_sb_state != 2'd0,
  ...
  assign v__h4941 =
	     (rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign word64__h7051 = { 32'd0, write_dm_word } ;
  ...
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: axi4_size_val__h5395 = rg_sbcs_sbaccess;
      default: axi4_size_val__h5395 = 3'b011;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2, 3'd3:
	  _theResult___snd_snd_val__h7121 = rg_sbcs_sbaccess;
      default: _theResult___snd_snd_val__h7121 = 3'b111;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  strobe64__h7104 or strobe64__h7108 or strobe64__h7112)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: wrd_wstrb__h7231 = strobe64__h7104;
      3'd1: wrd_wstrb__h7231 = strobe64__h7108;
      3'd2: wrd_wstrb__h7231 = strobe64__h7112;
      3'd3: wrd_wstrb__h7231 = 8'b11111111;
      default: wrd_wstrb__h7231 = 8'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
  ...
  always@(rg_sbcs_sbaccess or word64__h7051 or _theResult___fst__h7106)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: wrd_wdata__h7230 = _theResult___fst__h7106;
      default: wrd_wdata__h7230 = word64__h7051;
    endcase
  end
