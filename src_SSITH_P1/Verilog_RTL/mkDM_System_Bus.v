...
//
// On Fri Jun 21 16:21:40 BST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_System_Bus(CLK,
  ...
  wire [63 : 0] master_araddr, master_awaddr;
  ...
  reg [137 : 0] master_xactor_shim_rff_rv;
  wire [137 : 0] master_xactor_shim_rff_rv$D_IN;
  wire master_xactor_shim_rff_rv$EN;

  // register master_xactor_shim_wff_rv
  reg [147 : 0] master_xactor_shim_wff_rv;
  wire [147 : 0] master_xactor_shim_wff_rv$D_IN;
  ...
  reg [63 : 0] CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q6,
	       IF_rg_sbaddress_reading_1_BITS_2_TO_0_2_EQ_0x0_ETC___d104,
	       IF_rg_sbaddress_reading_1_BITS_2_TO_0_2_EQ_0x0_ETC___d117,
	       IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_1_ELSE_IF_rg_ETC___d156,
	       IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_IF_rg_sbaddr_ETC___d131,
	       x__h7224;
  reg [7 : 0] x__h7313;
  reg [2 : 0] _theResult___snd_snd_val__h7104, axi4_size_val__h5373;
  wire [146 : 0] master_xactor_shim_wff_rvport1__read_BITS_146_ETC__q4;
  wire [127 : 0] wrd_wdata__h7218;
  ...
  wire [63 : 0] _theResult___fst__h7089,
		addr64395_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_TH_ETC__q1,
		addr64__h6395,
		result__h3810,
		result__h3840,
		result__h3867,
		...
		result__h4169,
		result__h4196,
		sbaddress101_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_ETC__q2,
		sbaddress__h3101,
		word64__h7034;
  wire [31 : 0] IF_rg_sbcs_sbreadonaddr_76_THEN_IF_rg_sbcs_sba_ETC___d362,
		v__h4785,
		v__h4919;
  wire [15 : 0] wrd_wstrb__h7219;
  wire [7 : 0] strobe64__h7087, strobe64__h7091, strobe64__h7095;
  wire [5 : 0] shift_bits__h7037;
  wire rg_sb_state_7_EQ_0_40_AND_NOT_rg_sbcs_sbbusyer_ETC___d148,
       rg_sb_state_7_EQ_0_40_AND_NOT_rg_sbcs_sbbusyer_ETC___d162,
       rg_sb_state_7_EQ_0_40_AND_NOT_rg_sbcs_sbbusyer_ETC___d368,
       ...
       write_dm_addr_EQ_0x3C_16_AND_rg_sb_state_7_EQ__ETC___d378;
  ...
  // value method master_w_wdata
  assign master_wdata =
	     master_xactor_shim_wff_rvport1__read_BITS_146_ETC__q4[146:19] ;

  // value method master_w_wstrb
  assign master_wstrb =
	     master_xactor_shim_wff_rvport1__read_BITS_146_ETC__q4[18:3] ;

  // value method master_w_wlast
  assign master_wlast =
	     master_xactor_shim_wff_rvport1__read_BITS_146_ETC__q4[2] ;

  // value method master_w_wuser
  assign master_wuser =
	     master_xactor_shim_wff_rvport1__read_BITS_146_ETC__q4[1:0] ;
  ...
  // value method master_r_rready
  assign master_rready = !master_xactor_shim_rff_rv[137] ;
  ...
  assign CAN_FIRE_RL_rl_sb_read_finish =
	     ...
	     master_xactor_shim_rff_rv$port1__read[137] &&
	     rg_sb_state == 2'd1 &&
	     rg_sbcs_sberror == 3'd0 ;
  ...
  assign CAN_FIRE_RL_master_xactor_ug_master_u_w_setPeek =
	     master_xactor_shim_wff_rv$port1__read[147] ;
  ...
  assign MUX_rg_sbaddress0$write_1__SEL_2 =
	     ...
	     (rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	      ...
	      write_dm_addr == 7'h39 ||
	      write_dm_addr == 7'h3C &&
	      rg_sb_state_7_EQ_0_40_AND_NOT_rg_sbcs_sbbusyer_ETC___d148) ;
  ...
  always@(write_dm_addr or
	  sbaddress101_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_ETC__q2 or
	  IF_rg_sbcs_sbreadonaddr_76_THEN_IF_rg_sbcs_sba_ETC___d362)
  begin
    case (write_dm_addr)
      7'h39, 7'h3A:
      ...
      default: MUX_rg_sbaddress0$write_1__VAL_2 =
		   sbaddress101_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_ETC__q2[31:0];
    endcase
  end
  ...
  assign master_xactor_ug_master_u_r_putWire$whas =
	     master_rvalid && !master_xactor_shim_rff_rv[137] ;
  ...
  assign master_xactor_ug_master_u_w_dropWire$whas =
	     master_xactor_shim_wff_rv$port1__read[147] && master_wready ;
  ...
  always@(EN_reset or
	  ...
	  IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_IF_rg_sbaddr_ETC___d131 or
	  MUX_rg_sbdata0$write_1__SEL_3 or write_dm_word)
  case (1'b1)
    EN_reset: rg_sbdata0$D_IN = 32'd0;
    WILL_FIRE_RL_rl_sb_read_finish:
	rg_sbdata0$D_IN =
	    IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_IF_rg_sbaddr_ETC___d131[31:0];
  ...
  // remaining internal signals
  assign IF_rg_sbcs_sbreadonaddr_76_THEN_IF_rg_sbcs_sba_ETC___d362 =
	     rg_sbcs_sbreadonaddr ?
	       (rg_sbcs_sbautoincrement ?
		  addr64395_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_TH_ETC__q1[31:0] :
		  write_dm_word) :
	       write_dm_word ;
  assign _theResult___fst__h7089 = word64__h7034 << shift_bits__h7037 ;
  assign addr64395_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_TH_ETC__q1 =
	     addr64__h6395 +
	     IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_1_ELSE_IF_rg_ETC___d156 ;
  ...
  assign master_xactor_shim_wff_rvport1__read_BITS_146_ETC__q4 =
	     master_xactor_shim_wff_rv$port1__read[146:0] ;
  ...
  assign rg_sb_state_7_EQ_0_40_AND_NOT_rg_sbcs_sbbusyer_ETC___d148 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbautoincrement ;
  assign rg_sb_state_7_EQ_0_40_AND_NOT_rg_sbcs_sbbusyer_ETC___d162 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadondata ;
  assign rg_sb_state_7_EQ_0_40_AND_NOT_rg_sbcs_sbbusyer_ETC___d368 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadonaddr ;
  assign rg_sbcs_sberror_9_EQ_0_0_AND_rg_sbcs_sbreadona_ETC___d346 =
	     ...
	     (rg_sbcs_sbreadonaddr && rg_sbcs_sbautoincrement ||
	      write_dm_addr != 7'h39) ;
  assign sbaddress101_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_ETC__q2 =
	     sbaddress__h3101 +
	     IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_1_ELSE_IF_rg_ETC___d156 ;
  ...
  assign wrd_wdata__h7218 = { 64'd0, x__h7224 } ;
  assign wrd_wstrb__h7219 = { 8'd0, x__h7313 } ;
  ...
  assign write_dm_addr_EQ_0x3C_16_AND_rg_sb_state_7_EQ__ETC___d378 =
  ...
  begin
    case (rg_sbcs_sbaccess)
      3'd0: x__h7313 = strobe64__h7087;
      3'd1: x__h7313 = strobe64__h7091;
      3'd2: x__h7313 = strobe64__h7095;
      3'd3: x__h7313 = 8'b11111111;
      default: x__h7313 = 8'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess or word64__h7034 or _theResult___fst__h7089)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: x__h7224 = _theResult___fst__h7089;
      default: x__h7224 = word64__h7034;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_1_ELSE_IF_rg_ETC___d156 = 64'd1;
      3'd1: IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_1_ELSE_IF_rg_ETC___d156 = 64'd2;
      3'd2: IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_1_ELSE_IF_rg_ETC___d156 = 64'd4;
      3'd3: IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_1_ELSE_IF_rg_ETC___d156 = 64'd8;
      default: IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_1_ELSE_IF_rg_ETC___d156 =
		   64'd16;
    endcase
  end
  ...
  begin
    case (rg_sbaddress_reading[2:0])
      3'h0:
	  CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q6 =
	      result__h4169;
      3'h4:
	  CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q6 =
	      result__h4196;
      default: CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q6 = 64'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  IF_rg_sbaddress_reading_1_BITS_2_TO_0_2_EQ_0x0_ETC___d104 or
	  IF_rg_sbaddress_reading_1_BITS_2_TO_0_2_EQ_0x0_ETC___d117 or
	  CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q6 or
  ...
  begin
    case (rg_sbcs_sbaccess)
	  ...
	  IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_IF_rg_sbaddr_ETC___d131 =
		...
		64'd0;
      default: IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_IF_rg_sbaddr_ETC___d131 =
		   64'd0;
    endcase
  end
  ...
  begin
    ...
    master_xactor_shim_rff_rv = 138'h2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    master_xactor_shim_wff_rv = 148'hAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    rg_sb_state = 2'h2;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_sb_read_finish &&
	  master_xactor_shim_rff_rv$port1__read[4:3] != 2'd0)
	$write("'h%h", master_xactor_shim_rff_rv$port1__read[136:133]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_sb_read_finish &&
	  master_xactor_shim_rff_rv$port1__read[4:3] != 2'd0)
	$write(", ", "rdata: ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_sb_read_finish &&
	  master_xactor_shim_rff_rv$port1__read[4:3] != 2'd0)
	$write("'h%h", master_xactor_shim_rff_rv$port1__read[132:5]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_sb_read_finish &&
	  master_xactor_shim_rff_rv$port1__read[4:3] != 2'd0)
	$write(", ", "rresp: ");
