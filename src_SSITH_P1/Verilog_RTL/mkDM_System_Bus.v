...
//
// On Thu Jul 11 16:07:15 BST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_System_Bus(CLK,
  ...
  reg [63 : 0] CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q1,
	       ...
	       wrd_wdata__h7242;
  reg [7 : 0] wrd_wstrb__h7243;
  reg [2 : 0] _theResult___snd_snd_val__h7128, axi4_size_val__h5397;
  ...
  wire [63 : 0] _theResult___fst__h7113,
		addr64419_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_TH_ETC__q2,
		addr64__h6419,
		result__h3810,
		result__h3840,
		result__h3867,
  ...
  wire [31 : 0] IF_rg_sbcs_sbreadonaddr_75_THEN_IF_rg_sbcs_sba_ETC___d361,
		v__h4809,
		v__h4943;
  wire [7 : 0] strobe64__h7111, strobe64__h7115, strobe64__h7119;
  wire [5 : 0] shift_bits__h7061;
  ...
  always@(av_read_dm_addr or
	  v__h4809 or rg_sbaddress0 or rg_sbaddress1 or v__h4943)
  begin
    case (av_read_dm_addr)
      7'h38: av_read = v__h4809;
      7'h39: av_read = rg_sbaddress0;
      7'h3A: av_read = rg_sbaddress1;
      7'h3C: av_read = v__h4943;
  ...
  assign MUX_master_xactor_shim_arff_rv$port0__write_1__VAL_1 =
	     { 5'd16,
	       sbaddress__h3101,
	       8'd0,
	       axi4_size_val__h5397,
	       18'd65536 } ;
  assign MUX_master_xactor_shim_arff_rv$port0__write_1__VAL_2 =
	     { 5'd16, addr64__h6419, 8'd0, axi4_size_val__h5397, 18'd65536 } ;
  ...
  assign master_xactor_shim_awff_rv$port0__write_1 =
	     { 5'd16,
	       sbaddress__h3101,
	       8'd0,
	       _theResult___snd_snd_val__h7128,
	       18'd65536 } ;
  ...
  assign master_xactor_shim_wff_rv$port0__write_1 =
	     { 1'd1, wrd_wdata__h7242, wrd_wstrb__h7243, 3'd6 } ;
  ...
  assign IF_rg_sbcs_sbreadonaddr_75_THEN_IF_rg_sbcs_sba_ETC___d361 =
	     rg_sbcs_sbreadonaddr ?
		  ...
		  addr64419_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_TH_ETC__q2[31:0] :
		  write_dm_word) :
	       write_dm_word ;
  assign _theResult___fst__h7113 = word64__h7058 << shift_bits__h7061 ;
  assign addr64419_PLUS_IF_rg_sbcs_sbaccess_9_EQ_0_0_TH_ETC__q2 =
	     addr64__h6419 +
	     IF_rg_sbcs_sbaccess_9_EQ_0_0_THEN_1_ELSE_IF_rg_ETC___d155 ;
  assign addr64__h6419 = { rg_sbaddress1, write_dm_word } ;
  ...
  assign shift_bits__h7061 = { rg_sbaddress0[2:0], 3'b0 } ;
  assign strobe64__h7111 = 8'b00000001 << rg_sbaddress0[2:0] ;
  assign strobe64__h7115 = 8'b00000011 << rg_sbaddress0[2:0] ;
  assign strobe64__h7119 = 8'b00001111 << rg_sbaddress0[2:0] ;
  assign v__h4809 =
	     { 9'd64,
	       rg_sbcs_sbbusyerror,
	       rg_sb_state != 2'd0,
  ...
  assign v__h4943 =
	     (rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign word64__h7058 = { 32'd0, write_dm_word } ;
  ...
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: axi4_size_val__h5397 = rg_sbcs_sbaccess;
      default: axi4_size_val__h5397 = 3'b011;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2, 3'd3:
	  _theResult___snd_snd_val__h7128 = rg_sbcs_sbaccess;
      default: _theResult___snd_snd_val__h7128 = 3'b111;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  strobe64__h7111 or strobe64__h7115 or strobe64__h7119)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: wrd_wstrb__h7243 = strobe64__h7111;
      3'd1: wrd_wstrb__h7243 = strobe64__h7115;
      3'd2: wrd_wstrb__h7243 = strobe64__h7119;
      3'd3: wrd_wstrb__h7243 = 8'b11111111;
      default: wrd_wstrb__h7243 = 8'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
  ...
  always@(rg_sbcs_sbaccess or word64__h7058 or _theResult___fst__h7113)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: wrd_wdata__h7242 = _theResult___fst__h7113;
      default: wrd_wdata__h7242 = word64__h7058;
    endcase
  end
