...
module mkDM_System_Bus(CLK,
  ...
  reg [63 : 0] CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q1,
	       IF_rg_sbaddress_reading_4_BITS_2_TO_0_5_EQ_0x0_ETC___d47,
	       IF_rg_sbaddress_reading_4_BITS_2_TO_0_5_EQ_0x0_ETC___d60,
	       IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_1_ELSE_IF_rg_ETC___d96,
	       IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_IF_rg_sbaddr_ETC___d74,
	       wrd_wdata__h4413;
  reg [7 : 0] wrd_wstrb__h4414;
  reg [2 : 0] x__h4324;
  wire [63 : 0] _theResult___fst__h4362,
		addr64713_PLUS_IF_rg_sbcs_sbaccess_2_EQ_0_3_TH_ETC__q2,
		addr64__h3713,
		result__h1128,
		result__h1158,
		result__h1185,
		...
		result__h1487,
		result__h1514,
		sbaddress36_PLUS_IF_rg_sbcs_sbaccess_2_EQ_0_3__ETC__q3,
		sbaddress__h636,
		word64__h4306;
  wire [31 : 0] IF_rg_sbcs_sbreadonaddr_08_THEN_IF_rg_sbcs_sba_ETC___d292,
		v__h2070,
		v__h2183;
  wire [7 : 0] strobe64__h4361, strobe64__h4364, strobe64__h4367;
  wire [5 : 0] shift_bits__h4309;
  wire NOT_rg_sb_state_EQ_0_2_05_OR_rg_sbcs_sbbusyerr_ETC___d428,
       NOT_rg_sbcs_sbbusyerror_3_4_AND_rg_sbcs_sberro_ETC___d275,
       rg_sb_state_EQ_0_2_AND_NOT_rg_sbcs_sbbusyerror_ETC___d101,
       rg_sb_state_EQ_0_2_AND_NOT_rg_sbcs_sbbusyerror_ETC___d296,
       rg_sb_state_EQ_0_2_AND_NOT_rg_sbcs_sbbusyerror_ETC___d88,
       write_dm_addr_EQ_0x38_25_AND_rg_sbcs_sberror_E_ETC___d240,
       write_dm_addr_EQ_0x38_25_AND_rg_sbcs_sberror_E_ETC___d249,
       write_dm_addr_EQ_0x38_25_AND_rg_sbcs_sberror_E_ETC___d255,
       write_dm_addr_EQ_0x38_25_AND_rg_sbcs_sberror_E_ETC___d257,
       write_dm_addr_EQ_0x38_25_AND_rg_sbcs_sberror_E_ETC___d262,
       write_dm_addr_EQ_0x39_42_OR_write_dm_addr_EQ_0_ETC___d282,
       write_dm_addr_EQ_0x3C_45_AND_rg_sb_state_EQ_0__ETC___d302;
  ...
  always@(av_read_dm_addr or
	  v__h2070 or rg_sbaddress0 or rg_sbaddress1 or v__h2183)
  begin
    case (av_read_dm_addr)
      7'h38: av_read = v__h2070;
      7'h39: av_read = rg_sbaddress0;
      7'h3A: av_read = rg_sbaddress1;
      7'h3C: av_read = v__h2183;
  ...
  assign CAN_FIRE_write =
	     NOT_rg_sb_state_EQ_0_2_05_OR_rg_sbcs_sbbusyerr_ETC___d428 &&
  ...
  assign MUX_master_xactor_f_rd_addr$enq_1__VAL_2 =
	     { 4'd0, addr64__h3713, 8'd0, rg_sbcs_sbaccess, 18'd65536 } ;
  always@(write_dm_addr or
	  sbaddress36_PLUS_IF_rg_sbcs_sbaccess_2_EQ_0_3__ETC__q3 or
	  IF_rg_sbcs_sbreadonaddr_08_THEN_IF_rg_sbcs_sba_ETC___d292)
  begin
    case (write_dm_addr)
      7'h39, 7'h3A:
      ...
      default: MUX_rg_sbaddress0$write_1__VAL_2 =
		   sbaddress36_PLUS_IF_rg_sbcs_sbaccess_2_EQ_0_3__ETC__q3[31:0];
    endcase
  end
  ...
  always@(EN_reset or
	  ...
	  IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_IF_rg_sbaddr_ETC___d74 or
	  MUX_rg_sbdata0$write_1__SEL_3 or write_dm_word)
  case (1'b1)
    EN_reset: rg_sbdata0$D_IN = 32'd0;
    WILL_FIRE_RL_rl_sb_read_finish:
	rg_sbdata0$D_IN =
	    IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_IF_rg_sbaddr_ETC___d74[31:0];
  ...
  assign master_xactor_f_wr_addr$D_IN =
	     { 4'd0, sbaddress__h636, 8'd0, x__h4324, 18'd65536 } ;
  ...
  assign master_xactor_f_wr_data$D_IN =
	     { wrd_wdata__h4413, wrd_wstrb__h4414, 1'd1 } ;
  ...
  // remaining internal signals
  assign IF_rg_sbcs_sbreadonaddr_08_THEN_IF_rg_sbcs_sba_ETC___d292 =
	     rg_sbcs_sbreadonaddr ?
	       (rg_sbcs_sbautoincrement ?
		  addr64713_PLUS_IF_rg_sbcs_sbaccess_2_EQ_0_3_TH_ETC__q2[31:0] :
		  write_dm_word) :
	       write_dm_word ;
  assign NOT_rg_sb_state_EQ_0_2_05_OR_rg_sbcs_sbbusyerr_ETC___d428 =
	     rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	     rg_sbcs_sberror != 3'd0 ||
	     !rg_sbcs_sbreadonaddr ||
	     master_xactor_f_rd_addr$FULL_N ;
  assign NOT_rg_sbcs_sbbusyerror_3_4_AND_rg_sbcs_sberro_ETC___d275 =
	     !rg_sbcs_sbbusyerror && rg_sbcs_sberror == 3'd0 &&
	     (rg_sbcs_sbreadonaddr && rg_sbcs_sbautoincrement ||
	      write_dm_addr != 7'h39) ;
  assign _theResult___fst__h4362 = word64__h4306 << shift_bits__h4309 ;
  assign addr64713_PLUS_IF_rg_sbcs_sbaccess_2_EQ_0_3_TH_ETC__q2 =
	     addr64__h3713 +
	     IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_1_ELSE_IF_rg_ETC___d96 ;
  assign addr64__h3713 = { rg_sbaddress1, write_dm_word } ;
  assign result__h1128 = { 56'd0, master_xactor_f_rd_data$D_OUT[10:3] } ;
  assign result__h1158 = { 56'd0, master_xactor_f_rd_data$D_OUT[18:11] } ;
  assign result__h1185 = { 56'd0, master_xactor_f_rd_data$D_OUT[26:19] } ;
  assign result__h1212 = { 56'd0, master_xactor_f_rd_data$D_OUT[34:27] } ;
  assign result__h1239 = { 56'd0, master_xactor_f_rd_data$D_OUT[42:35] } ;
  assign result__h1266 = { 56'd0, master_xactor_f_rd_data$D_OUT[50:43] } ;
  assign result__h1293 = { 56'd0, master_xactor_f_rd_data$D_OUT[58:51] } ;
  assign result__h1320 = { 56'd0, master_xactor_f_rd_data$D_OUT[66:59] } ;
  assign result__h1365 = { 48'd0, master_xactor_f_rd_data$D_OUT[18:3] } ;
  assign result__h1392 = { 48'd0, master_xactor_f_rd_data$D_OUT[34:19] } ;
  assign result__h1419 = { 48'd0, master_xactor_f_rd_data$D_OUT[50:35] } ;
  assign result__h1446 = { 48'd0, master_xactor_f_rd_data$D_OUT[66:51] } ;
  assign result__h1487 = { 32'd0, master_xactor_f_rd_data$D_OUT[34:3] } ;
  assign result__h1514 = { 32'd0, master_xactor_f_rd_data$D_OUT[66:35] } ;
  assign rg_sb_state_EQ_0_2_AND_NOT_rg_sbcs_sbbusyerror_ETC___d101 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadondata ;
  assign rg_sb_state_EQ_0_2_AND_NOT_rg_sbcs_sbbusyerror_ETC___d296 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadonaddr ;
  assign rg_sb_state_EQ_0_2_AND_NOT_rg_sbcs_sbbusyerror_ETC___d88 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbautoincrement ;
  assign sbaddress36_PLUS_IF_rg_sbcs_sbaccess_2_EQ_0_3__ETC__q3 =
	     sbaddress__h636 +
	     IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_1_ELSE_IF_rg_ETC___d96 ;
  assign sbaddress__h636 = { rg_sbaddress1, rg_sbaddress0 } ;
  assign shift_bits__h4309 = { rg_sbaddress0[2:0], 3'b0 } ;
  assign strobe64__h4361 = 8'b00000001 << rg_sbaddress0[2:0] ;
  assign strobe64__h4364 = 8'b00000011 << rg_sbaddress0[2:0] ;
  assign strobe64__h4367 = 8'b00001111 << rg_sbaddress0[2:0] ;
  assign v__h2070 =
	     { 9'd64,
	       rg_sbcs_sbbusyerror,
	       rg_sb_state != 2'd0,
  ...
  assign v__h2183 =
	     (rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign word64__h4306 = { 32'd0, write_dm_word } ;
  assign write_dm_addr_EQ_0x38_25_AND_rg_sbcs_sberror_E_ETC___d240 =
	     write_dm_addr == 7'h38 &&
  ...
  assign write_dm_addr_EQ_0x38_25_AND_rg_sbcs_sberror_E_ETC___d249 =
	     write_dm_addr_EQ_0x38_25_AND_rg_sbcs_sberror_E_ETC___d240 ||
	     (write_dm_addr == 7'h39 || write_dm_addr == 7'h3A ||
	      write_dm_addr == 7'h3C) &&
	     rg_sb_state != 2'd0 ;
  assign write_dm_addr_EQ_0x38_25_AND_rg_sbcs_sberror_E_ETC___d255 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     rg_sbcs_sbbusyerror &&
	     !write_dm_word[22] ;
  assign write_dm_addr_EQ_0x38_25_AND_rg_sbcs_sberror_E_ETC___d257 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || write_dm_word[22]) ;
  assign write_dm_addr_EQ_0x38_25_AND_rg_sbcs_sberror_E_ETC___d262 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || write_dm_word[22]) &&
	     (write_dm_word[19:17] == 3'd4 || write_dm_word[19:17] == 3'd3) ;
  assign write_dm_addr_EQ_0x39_42_OR_write_dm_addr_EQ_0_ETC___d282 =
	     (write_dm_addr == 7'h39 || write_dm_addr == 7'h3A) &&
	     rg_sb_state == 2'd0 &&
	     NOT_rg_sbcs_sbbusyerror_3_4_AND_rg_sbcs_sberro_ETC___d275 ||
	     write_dm_addr == 7'h3C &&
	     rg_sb_state_EQ_0_2_AND_NOT_rg_sbcs_sbbusyerror_ETC___d88 ;
  assign write_dm_addr_EQ_0x3C_45_AND_rg_sb_state_EQ_0__ETC___d302 =
  ...
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2, 3'd3: x__h4324 = rg_sbcs_sbaccess;
      default: x__h4324 = 3'b111;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  strobe64__h4361 or strobe64__h4364 or strobe64__h4367)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: wrd_wstrb__h4414 = strobe64__h4361;
      3'd1: wrd_wstrb__h4414 = strobe64__h4364;
      3'd2: wrd_wstrb__h4414 = strobe64__h4367;
      3'd3: wrd_wstrb__h4414 = 8'b11111111;
      default: wrd_wstrb__h4414 = 8'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess or word64__h4306 or _theResult___fst__h4362)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: wrd_wdata__h4413 = _theResult___fst__h4362;
      default: wrd_wdata__h4413 = word64__h4306;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_1_ELSE_IF_rg_ETC___d96 = 64'd1;
      3'd1: IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_1_ELSE_IF_rg_ETC___d96 = 64'd2;
      3'd2: IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_1_ELSE_IF_rg_ETC___d96 = 64'd4;
      3'd3: IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_1_ELSE_IF_rg_ETC___d96 = 64'd8;
      default: IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_1_ELSE_IF_rg_ETC___d96 =
		   64'd16;
    endcase
  end
  always@(rg_sbaddress_reading or
	  ...
	  result__h1185 or
	  result__h1212 or
	  result__h1239 or result__h1266 or result__h1293 or result__h1320)
  begin
  ...
  always@(rg_sbaddress_reading or
	  result__h1365 or result__h1392 or result__h1419 or result__h1446)
  begin
    case (rg_sbaddress_reading[2:0])
      3'h0:
	  IF_rg_sbaddress_reading_4_BITS_2_TO_0_5_EQ_0x0_ETC___d60 =
	  ...
	  IF_rg_sbaddress_reading_4_BITS_2_TO_0_5_EQ_0x0_ETC___d60 =
	      result__h1446;
      default: IF_rg_sbaddress_reading_4_BITS_2_TO_0_5_EQ_0x0_ETC___d60 =
		   64'd0;
    endcase
  end
  always@(rg_sbaddress_reading or result__h1487 or result__h1514)
  begin
    case (rg_sbaddress_reading[2:0])
      3'h0:
  ...
  always@(rg_sbcs_sbaccess or
	  IF_rg_sbaddress_reading_4_BITS_2_TO_0_5_EQ_0x0_ETC___d47 or
	  IF_rg_sbaddress_reading_4_BITS_2_TO_0_5_EQ_0x0_ETC___d60 or
  ...
  begin
    case (rg_sbcs_sbaccess)
	  ...
	  IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_IF_rg_sbaddr_ETC___d74 =
		...
		64'd0;
      default: IF_rg_sbcs_sbaccess_2_EQ_0_3_THEN_IF_rg_sbaddr_ETC___d74 =
		   64'd0;
    endcase
  end
