...
//
// On Tue Aug 20 14:57:26 BST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_Abstract_Commands(CLK,
  ...
  wire [31 : 0] virt_rg_abstractcs__h480, virt_rg_command__h526;
  wire [15 : 0] regno__h1831;
  wire [12 : 0] x__h1013;
  wire rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d35,
       rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d46,
       rg_abstractcs_cmderr_read__0_EQ_0_4_AND_write__ETC___d105,
       rg_abstractcs_cmderr_read__0_EQ_0_4_AND_write__ETC___d137,
  ...
  always@(av_read_dm_addr or
	  rg_data0 or virt_rg_abstractcs__h480 or virt_rg_command__h526)
  begin
    case (av_read_dm_addr)
      7'h16: av_read = virt_rg_abstractcs__h480;
      7'h17: av_read = virt_rg_command__h526;
  ...
  assign MUX_f_hart0_gpr_reqs$enq_1__VAL_1 =
	     { 1'd1, x__h1013[4:0], rg_data0 } ;
  assign MUX_f_hart0_gpr_reqs$enq_1__VAL_2 =
	     { 1'd0, x__h1013[4:0], 32'hAAAAAAAA } ;
  ...
  // remaining internal signals
  assign regno__h1831 = { 3'd0, rg_command_access_reg_regno } ;
  ...
  assign rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d46 =
	     ...
	     !rg_command_access_reg_regno_read_ULT_0x1000___d31 &&
	     rg_command_access_reg_regno_read_ULE_0x101F___d33 ;
  assign rg_abstractcs_cmderr_read__0_EQ_0_4_AND_write__ETC___d105 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     write_dm_word[24] ;
  assign rg_abstractcs_cmderr_read__0_EQ_0_4_AND_write__ETC___d137 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
  ...
  assign virt_rg_abstractcs__h480 =
	     { 19'd0, rg_abstractcs_busy, 1'b0, rg_abstractcs_cmderr, 8'd1 } ;
  assign virt_rg_command__h526 =
	     { 15'd17, rg_command_access_reg_write, regno__h1831 } ;
  ...
  assign x__h1013 = rg_command_access_reg_regno - 13'h1000 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  write_dm_addr != 7'h17 &&
	  write_dm_addr != 7'h04)
	$write("%0d: DM_Abstract_Commands.write: [", v__h3233);
    if (RST_N != `BSV_RESET_VALUE)
