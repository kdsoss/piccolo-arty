...
void MOD_mkGPR_RegFile::init_symbols_0()
{
  ...
  init_symbol(&symbols[5u], "rg_state__h333", SYM_DEF, &DEF_rg_state__h333, 2u);
}
...
tUInt8 MOD_mkGPR_RegFile::METH_RDY_server_reset_response_get()
{
  ...
  DEF_rg_state__h333 = INST_rg_state.METH_read();
  DEF_CAN_FIRE_server_reset_response_get = DEF_rg_state__h333 == (tUInt8)2u && INST_f_reset_rsps.METH_i_notEmpty();
...
{
  tUInt8 DEF_read_rs1_rs1_EQ_0___d6;
  tUInt64 DEF_x__h494;
  tUInt64 PORT_read_rs1;
  DEF_x__h494 = INST_regfile.METH_sub(ARG_read_rs1_rs1);
  DEF_read_rs1_rs1_EQ_0___d6 = ARG_read_rs1_rs1 == (tUInt8)0u;
  PORT_read_rs1 = DEF_read_rs1_rs1_EQ_0___d6 ? 0llu : DEF_x__h494;
...
{
  tUInt8 DEF_read_rs1_port2_rs1_EQ_0___d8;
  tUInt64 DEF_x__h497;
  tUInt64 PORT_read_rs1_port2;
  DEF_x__h497 = INST_regfile.METH_sub(ARG_read_rs1_port2_rs1);
  DEF_read_rs1_port2_rs1_EQ_0___d8 = ARG_read_rs1_port2_rs1 == (tUInt8)0u;
  PORT_read_rs1_port2 = DEF_read_rs1_port2_rs1_EQ_0___d8 ? 0llu : DEF_x__h497;
...
{
  tUInt8 DEF_read_rs2_rs2_EQ_0___d10;
  tUInt64 DEF_x__h500;
  tUInt64 PORT_read_rs2;
  DEF_x__h500 = INST_regfile.METH_sub(ARG_read_rs2_rs2);
  DEF_read_rs2_rs2_EQ_0___d10 = ARG_read_rs2_rs2 == (tUInt8)0u;
  PORT_read_rs2 = DEF_read_rs2_rs2_EQ_0___d10 ? 0llu : DEF_x__h500;
...
{
  tUInt8 DEF_NOT_write_rd_rd_EQ_0_2___d13;
  DEF_NOT_write_rd_rd_EQ_0_2___d13 = !(ARG_write_rd_rd == (tUInt8)0u);
  if (DEF_NOT_write_rd_rd_EQ_0_2___d13)
...
unsigned int MOD_mkGPR_RegFile::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "rg_state__h333", 2u);
...
void MOD_mkGPR_RegFile::vcd_defs(tVCDDumpType dt, MOD_mkGPR_RegFile &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_rg_state__h333) != DEF_rg_state__h333)
      {
	vcd_write_val(sim_hdl, num, DEF_rg_state__h333, 2u);
	backing.DEF_rg_state__h333 = DEF_rg_state__h333;
      }
      ++num;
    }
    else
