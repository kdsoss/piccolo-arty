...
class MOD_mkBoot_ROM : public Module {
 ...
 private:
  ...
  tUWide DEF_slave_xactor_f_wr_addr_first____d1199;
  tUWide DEF_slave_xactor_f_rd_data_first____d1236;
  tUInt64 DEF_lim__h8758;
  tUInt64 DEF_base__h8756;
  tUInt8 DEF_slave_xactor_f_rd_data_i_notEmpty____d1235;
  tUInt8 DEF_slave_xactor_f_rd_addr_i_notFull____d1232;
  tUInt8 DEF_slave_xactor_f_wr_resp_i_notEmpty____d1230;
  tUInt8 DEF_slave_xactor_f_wr_data_i_notFull____d1227;
  tUInt8 DEF_slave_xactor_f_wr_addr_i_notFull____d1224;
  tUWide DEF_IF_NOT_slave_xactor_f_rd_addr_first_BITS_5_TO__ETC___d1192;
  tUWide DEF__0_CONCAT_IF_slave_xactor_f_rd_addr_first_BITS__ETC___d1191;
  tUWide DEF_slave_wdata_CONCAT_slave_wstrb___d1229;
  tUWide DEF_slave_araddr_CONCAT_slave_arprot___d1234;
  tUWide DEF_slave_awaddr_CONCAT_slave_awprot___d1226;
