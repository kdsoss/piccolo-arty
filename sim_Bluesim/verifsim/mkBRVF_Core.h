...
class MOD_mkBRVF_Core : public Module {
 ...
 public:
  ...
  void METH_cpu_external_interrupt_req(tUInt8 ARG_cpu_external_interrupt_req_set_not_clear);
  ...
  void METH_cpu_software_interrupt_req(tUInt8 ARG_cpu_software_interrupt_req_set_not_clear);
