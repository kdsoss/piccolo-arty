...
################################################################
# This is a generated script based on design: piccolo_6
#
...
proc write_mig_file_piccolo_6_mig_7series_0_0 { str_mig_prj_filepath } {
...
# End of write_mig_file_piccolo_6_mig_7series_0_0()
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    CONFIG.Coe_File "$script_folder/bootrom/bootrom.coe" \
  ...
  set_property CONFIG.Output_Width {1} $c_counter_binary_2
  ...
  write_mig_file_piccolo_6_mig_7series_0_0 $str_mig_file_path
  ...
  assign_bd_address -offset 0xC0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master0] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces mkP1_Core_0/master1] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
